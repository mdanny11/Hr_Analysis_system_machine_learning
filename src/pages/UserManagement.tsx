...
export default function UserManagement() {
  ...
  const handleCreateUser = async () => {
    ...
    try {
      ...
      setNewUser({ name: '', email: '', role: 'hr-analyst', department: '' });
      toast.success('User created successfully', { description: `Default password: password123` });
    } catch {
            ...
            <div className="space-y-4 py-4">
              ...
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(v: 'active' | 'inactive' | 'pending') => setSelectedUser({ ...selectedUser, status: v })}
                >
                  <SelectTrigger className="bg-white/5 border-white/10 text-white">
                    <SelectValue />
                  </SelectTrigger>
